...
# add both of bro's to an ipset
/usr/local/sbin/ipset -X BRO
/usr/local/sbin/ipset -N BRO iphash
/usr/local/sbin/ipset -A BRO 10.4.0.2
/usr/local/sbin/ipset -A BRO 141.212.109.159

/sbin/iptables-restore < /home/ewust/telex/net/tweedledum.fw
...
nohup /home/ewust/telex/net/flow_blocker 10.4.0.1 4501 < /dev/null > /dev/null &
